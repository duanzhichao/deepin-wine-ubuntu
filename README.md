...
## ！！！！！重点！！！！
> 本仓库fork自wszqkzqk/deepin-wine-ubuntu项目,为了解决Ubuntu16.04的安装问题，本仓库release有微信等deepin官方不再提供下载的包，如果觉得下载速度较慢，请点击[此处的(gitee)网址](https://gitee.com/duanzhichao/deepin-wine-ubuntu)克隆或者下载，项目和软件包
